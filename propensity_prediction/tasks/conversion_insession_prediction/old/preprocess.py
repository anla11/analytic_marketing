''' This file will be moved to utils later '''
...
def auto_preprocess(df, user_col, product_col, event_col, session_col, feature_types):
	df2, feature_types_2 = remove_objects(df, feature_types)
	df2 = format_df(df2, feature_types_2)
	features = list( set(df2.columns) - set([ user_col, product_col, event_col, session_col])) 
