...
class ChurnPrediction_ModelConfig(Base_ModelConfig):
	def __init__(self, pipeline_config_path):
		...
		super().__init__('Ensemble', default_config, pipeline_config_path, list_configs = ['binarize_config', 'feature_engineering', 'model_config'])
...
class Conversion_InSession_Prediction_ModelConfig(Base_ModelConfig):
	def __init__(self, pipeline_config_path):
		...
		# config_path = 'propensity_prediction/config/detail_model_config/conversioninsession_pipelineconfig.json'
		super().__init__('Ensemble', default_config, pipeline_config_path, list_configs = ['binarize_config', 'feature_engineering', 'model_config'])
...
class LTVPrediction_ModelConfig(Base_ModelConfig):
	def __init__(self, pipeline_config_path):
		...
		# config_path = 'propensity_prediction/config/detail_model_config/ltvprediction_pipelineconfig.json'
		super().__init__('Ensemble', default_config, pipeline_config_path, list_configs = ['feature_engineering', 'model_config'])
