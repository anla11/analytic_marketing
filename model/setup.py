...
setup(
    ...
    description="Common CS-level functions",
    long_description="Implement computational functions as library packages, including analysis, feature transformation, models and evaluation",
    long_description_content_type="text/markdown",
    url="https://github.com/primedata-ai/ds/model",
